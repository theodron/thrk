...
async def delete_after_delay(message: Message, delay):
    await asyncio.sleep(600)  # change this value to change Auto delete time
    ...
    if len(text)>7:
        ...
        for msg in messages:
            ...
            try:
                ...
                pass
        await message.reply_text(f"<b>‼️ This file will Delete after 10 minutes due to security policies of @Theodron ‼️</b>")
        return
    else:
